# 0276-sas-ata-isci-dont-t-disable-interrupts-in-qc_issue-h.patch分析

## 1 Patch原文

```patch
From e9183d939e1bca524924d49439dd98e091be890d Mon Sep 17 00:00:00 2001
...
从`linux-4.8.84-rt62中0089-usb-Use-_nort-in-giveback-function.patch的分析`能看出，这里的问题也是在`local_irq_save`关中断的情况下有一句`__might_sleep`。
